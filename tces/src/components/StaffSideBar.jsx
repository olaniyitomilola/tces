...
import { Home, Users, Truck, Wrench, X, CalendarDays } from 'lucide-react';
...
const StaffSidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Van',     icon: Truck,        path: '/dashboard/van'     },
    { name: 'Tools',   icon: Wrench,       path: '/dashboard/tools'   },
    { name: 'Shifts',  icon: CalendarDays, path: '/dashboard/shifts'  },
  ];
